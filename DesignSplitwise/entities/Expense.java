...
public class Expense {
    ...
    private Expense(ExpenseBuilder builder) {
        ...
        // Use the strategy to calculate split
        this.splits = builder.splitStrategy.calculateSplits(builder.amount,
                builder.paidBy, builder.participants, builder.splitValues);
    }
