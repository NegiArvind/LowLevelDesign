...
public class BalanceSheet {
    ...
    public void showBalances() {
        ...
        for(Map.Entry<User, Double> entry: balances.entrySet()) {
            ...
            if(amount > 0.01) {
                System.out.println(otherUser.getName() + " owes " + owner.getName() + " Rs " + String.format("%.2f", amount));
        ...
        System.out.println("Total Owed to " + owner.getName() + ": Rs " + String.format("%.2f", totalOwedToMe));
        System.out.println("Total " + owner.getName() + " Owes: Rs " + String.format("%.2f", totalIOwe));
        System.out.println("---------------------------------");
    }
}
